...
int main(void)
{
	...
	while(lives !=0 && challenge !=5)
	{
		...
		switch(options)
		{
			...
			case 1: printf("If you have a 100 euro and you spend  1/5th of it, How much did you spend? Enter the digits only.\n");
			scanf("%d",&ans1);
			if(ans1 == 20)
			{
			...
			case 2: printf("What is 2.2X10^3? Digits only please.\n");
			scanf("%d", &ans2);
			if(ans2 == 2200)
			{
				printf("Correct, Well Done\n");
			...
			case 3: printf("If you have a triangle of base 12cm and height of 5cm, what is the area? Digits only.\n");
			scanf("%d",&ans3);
			if(ans3 == 30)
			{
				printf("Correct, Well Done\n");
